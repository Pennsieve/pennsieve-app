<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 152.4 32"
    style="enable-background: new 0 0 152.4 32"
    xml:space="preserve"
    :fill="color"
  >
    <path
      d="M12.4,7.1C10.8,6,8.9,5.4,6.9,5.5H0v17.8h2.5v-5.4h4.4c1.9,0.1,3.9-0.5,5.4-1.6c1.3-1.1,2.1-2.8,2-4.5
    ...
    />
    <path
      d="M140.4,0h-16l0.1,0.1c10,7.4,16,19,16.2,31.5L152.4,16L140.4,0z M124.4,32h14.3c0-5.1-1.1-10.2-3.1-14.9
	L124.4,32z"
    />
  </svg>
</template>
