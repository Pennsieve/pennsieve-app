<template>
  <div class="dataset-activity-detail">
    ...
    <div
      v-if="eventDetail.eventType === 'ADD_CONTRIBUTOR'"
      class="dataset-activity-detail__info"
    >
      <div class="info-title">
        <p>Name:</p>
      ...
      <div class="dataset-activity-detail__info-link">
        <p>{{ eventDetail.detail.firstName }} {{ eventDetail.detail.lastName }}</p>
      </div>
    </div>
    ...
    <dataset-activity-description-dialog
      v-if="eventDetail.eventType === 'UPDATE_CHANGELOG'"
      class="event-details-wrap"
      type="changelog"
      action="updated"
      :description="eventDetail.detail.newChangelog"
    />
...
<script>
import FormatDisplayValue from '../../explore/ConceptInstance/format-display-value.js'
import DatasetActivityDescriptionDialog from '../../DatasetActivity/DatasetActivityDescriptionDialog/DatasetActivityDescriptionDialog.vue'

import DatasetReference from '../../../shared/DatasetReference/DatasetReference.vue'
