  ...
  methods: {
    ...
    createProperty: function() {
      this.$refs.propertyForm.validate((valid) => {
        ...
        if (this.editingProperty) {
          this.putCreateProperty(property)
    ...
    putCreateProperty: function(property) {

      // If selected to be primary prop, check existing props and update old primary prop
      let submitProps = [property]
      if (property.conceptTitle) {
        for (let p in this.model.props) {
          if (this.model.props[p].conceptTitle) {
            this.model.props[p].conceptTitle = false
            submitProps = [property, this.model.props[p]]
            break
          }
        }
      }
