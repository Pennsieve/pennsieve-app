    ...
    >
      ...
      <dialog-body ref="abcd">
        ...
        >
          ...
          <el-form-item label="Message (Optional)" prop="customMessage">
            <el-input
              type="textarea"
              :rows="4"
      ...
      <template #footer>
        ...
        <bf-button @click="sendInvite('invitationForm')"> Confirm </bf-button>
      </template>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    checkEmail: function (rule, value, callback) {
      ...
      const matchingMembers = list.filter(
