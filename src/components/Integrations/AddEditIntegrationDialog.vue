    ...
    <dialog-body>
      ...
      >
        ...
        <el-form-item prop="isPublic">
          <template #label>
            Application permissions <span class="label-helper"> </span>
            <div class="info">
              Allow the application to be used by everyone in the organization.
              By default the application is private and can only be managed by
              the current user.
            </div>
          </template>
          <el-checkbox
            v-model="integration.isPublic"
            label="Enable organization-wide use of application"
          />
        </el-form-item>
...
export default {
  ...
  computed: {
     ...
     */
    createText: function () {
      let createText = "Add Application";
      if (this.editingIntegration) {
        createText = "Update Application";
      }
    ...
    dialogTitle: function () {
      return this.editingIntegration ? "Update Application" : "Add Application";
    },
  },
  ...
  methods: {
    ...
    createIntegration: function () {
      let isValid = true;
      this.$refs.integrationFormStep1
        .validate((valid) => {
          if (!valid) {
            // switch tab views
            isValid = false;
