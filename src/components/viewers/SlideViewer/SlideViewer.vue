<template>
  <div class="slide-viewer">
    ...
    <slide-annotation-delete-dialog
      :dialog-visible="isSlideAnnotationDeleteDialogVisible"
  ...
  export default {
    ...
    computed: {
      ...
      wrapperStyle: function() {
        return this.isPreview ? "600px" : "auto"
      },
      /**
    ...
    watch: {
      ...
      isMeasuring: function(isMeasuring) {
        ...
        if (curIsMeasuring !== isMeasuring) {
          this.$store.dispatch('viewerModule/updateViewerSlideInfo', {
            isMeasuring
          })
        }
      },
    ...
    methods: {
      ...
      initViewer: function () {
        ...
        this.$store.watch(state => state.viewerModule.viewerSidePanelView, this.redrawSlideViewer.bind(this))
      },
      ...
      */
      ...
      updateState: function(evt, onOpen) {
        ...
        if (viewport) {
          ...
          this.$store.dispatch('viewerModule/updateViewerSlideInfo', state)
        }
      },
        ...
        this.sendXhr(this.getAnnotationsUrl)
          .then(response => {
            ...
            if (!layers.length) {
              ...
              this.$store.dispatch('viewerModule/setAnnotations', layers)
      ...
      _handleCreateAnnotation: function(response) {
        ...
        this.$store.dispatch('viewerModule/createAnnotation', annotation)
      ...
      _handleEditAnnotation: function(originalAnnotation, response) {
        ...
        if (originalAnnotation.newLayerId !== originalAnnotation.layer_id) {
          this.$store.dispatch('viewerModule/createAnnotation', annotation)
            .then(() => {
              this.$store.dispatch('viewerModule/deleteAnnotation', originalAnnotation)
            })
          ...
          this.$store.dispatch('viewerModule/updateAnnotation', annotation)
        }
