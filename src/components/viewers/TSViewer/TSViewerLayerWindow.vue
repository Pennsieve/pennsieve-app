    ...
    <template #default>
      <div slot="body">
        <div class="input-section">
          Layer Name:
          <el-input placeholder="Add a Layer Name" v-model="name" ref="input" />
        </div>
        <div class="input-section">
          Select Color:
    ...
    <template #footer>
      <div slot="footer">
        <div class="button-wrapper">
          <div class="buttons">
            <bf-button @click="handleFormCancel">Cancel </bf-button>
            <bf-button @click="handleFormSubmit">Save </bf-button>
          </div>
        </div>
      </div>
    </template>
